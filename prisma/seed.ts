...
async function main() {
  ...
  // Product Categories - Company 1
  const category1 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-01" },
    create: { id: "seed-cat-01", companyId: company1.id, name: "Radyografi Test Ürünleri" },
    update: {},
  });

  const category2 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-02" },
    create: { id: "seed-cat-02", companyId: company1.id, name: "Ultrasonik Test Ürünleri" },
    update: {},
  });

  const category3 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-03" },
    create: { id: "seed-cat-03", companyId: company1.id, name: "Penetrant Test Ürünleri" },
    update: {},
  });

  const category4 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-04" },
    create: { id: "seed-cat-04", companyId: company1.id, name: "Manyetik Parçacık Test Ürünleri" },
    update: {},
  });

  const category5 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-05" },
    create: { id: "seed-cat-05", companyId: company1.id, name: "Sertlik Ölçüm Cihazları" },
    update: {},
  });

  const category6 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-06" },
    create: { id: "seed-cat-06", companyId: company1.id, name: "Analitik Cihazlar" },
    update: {},
  });

  const category7 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-07" },
    create: { id: "seed-cat-07", companyId: company1.id, name: "Eğitim ve Sertifikasyon" },
    update: {},
  });

  const category8 = await prisma.productCategory.upsert({
    where: { id: "seed-cat-08" },
    create: { id: "seed-cat-08", companyId: company1.id, name: "Aksesuarlar" },
    update: {},
  });
