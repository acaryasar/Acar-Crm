      ...
      <div className="flex items-center gap-3 mb-4 shrink-0">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">
            {ticketId ? "WhatsApp Sohbet Geçmişi" : "WhatsApp AI"}
          </h1>
          <p className="text-sm text-slate-500">
            {ticketId ? "Ticket ile ilişkili WhatsApp mesajları" : "AI ile WhatsApp Asistanı"}
          </p>
        </div>
      </div>

      <div className="flex-1 min-h-0">
        <WhatsAppDemoChat ticketId={ticketId} />
      </div>
    </div>
  );
}
