...
export function DateRangeFilter({ initialStartDate, initialEndDate }: DateRangeFilterProps) {
  ...
  const handleGetReport = () => {
    ...
    alert(`Rapor oluşturuluyor: ${formatDateForDisplay(startDate)} - ${formatDateForDisplay(endDate)}`);
  };
