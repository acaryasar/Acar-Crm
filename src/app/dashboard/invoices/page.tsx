          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800">
                {mode === "create" ? t("newInvoice") : mode === "edit" ? t("editInvoice") : t("viewInvoice")}
              </h1>
              <p className="text-sm text-slate-500">
                {mode === "create" ? t("createInvoiceDesc") : invoice?.invoiceNumber}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {mode === "view" && invoice && (
              <>
                ...
                <Link 
                  href={`/dashboard/invoices?mode=edit&id=${invoice.id}`}
      ...
      <div className="flex items-center justify-between mb-6 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">{invoices.length} {t("invoices").toLowerCase()}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <InvoiceSearch />
          <Link
            href="/dashboard/invoices?mode=create"
