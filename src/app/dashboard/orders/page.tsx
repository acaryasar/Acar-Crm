          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800">
                {mode === "create" ? t("newOrder") : mode === "edit" ? t("editOrder") : t("viewOrder")}
              </h1>
              <p className="text-sm text-slate-500">
                {mode === "create" ? t("createOrderDesc") : order?.orderNumber}
              </p>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between mb-6 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">{orders.length} {t("orders").toLowerCase()}</p>
          </div>
        </div>
